...
$mail->Body    = 'Здравствуйте ' . $name . ' вы пытаетесь восстановить пароль от аккаунта на сайте "ingenerBlog" для задания нового пароля перейтите по ссылке: http://domen.loc/mail/resPassword.php/?token=' . $token;
$mail->AltBody = '';
